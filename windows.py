...
class MainWindow(QTabWidget):
    def __init__(self):
        ...
        self.class_names = ['AppleBraeburn', 'Banana','Blueberry','Cauliflower','Chestnut','Corn','Eggplant','Lemon','Lychee','Mandarine','Orange','Pear','Strawberry','Walnut', 'Watermelon']
        self.resize(700, 500)
        self.initUI()
